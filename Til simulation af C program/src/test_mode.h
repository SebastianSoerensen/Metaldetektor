...
#define ADC_BLOCK_N 64

extern const int16_t test_samples[ADC_BLOCK_N];

// Reference values for DFT verification
#define TEST_REF_RE     0
#define TEST_REF_IM    -500
#define TEST_REF_AMP   500
#define TEST_REF_PHASE -90
